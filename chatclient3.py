...
vbar=Scrollbar(top)
sf=("Helvetica",20)
msglist=Listbox(top,height=30,width=80,yscrollcommand=vbar.set,bg="pink",font=sf,fg="blue")
vbar.pack(side=RIGHT,fill=Y)
msglist.pack(side=RIGHT,fill=BOTH)
msglist.pack()
v=StringVar()
e1=Entry(top,width=35,font=large_font,relief=RAISED,textvariable=v)
e1.place(x=2,y=378)
